...
export class OrderServicesService {
  ...
  saveOrderReceived(orderReceivedData:any){
    return this.http.post<any>(this.commonService.getAPI() + '/saveOrder', orderReceivedData)
  ...
  fetchAllOrder($orgID:any){
    return this.http.get<any>(this.commonService.getAPI() + '/getAllOrder/'+$orgID)
  ...
  fetchAllEmployeeServiceSchedule($orgID:any){
    return this.http.get<any>(this.commonService.getAPI() + '/getEmployeeServiceSchedule/'+$orgID)
    .pipe(catchError(this.errorService.serverError), tap(((response: {success: number, data: any[]}) => {
      this.feesReceivedList=response.data;
      this.feesReceivedSubject.next([...this.feesReceivedList]);
    })));
  }
  fetchAllEmployeeServiceScheduleById($orgID:any,$id:any){
    return this.http.get<any>(this.commonService.getAPI() + '/getEmployeeServiceScheduleById/'+$orgID+'/'+$id)
    .pipe(catchError(this.errorService.serverError), tap(((response: {success: number, data: any[]}) => {
      this.feesReceivedList=response.data;
      this.feesReceivedSubject.next([...this.feesReceivedList]);
    })));
  }
  fetchAllEmployeeServiceScheduleByDate($orgID:any,$date:any){
    return this.http.get<any>(this.commonService.getAPI() + '/getEmployeeServiceScheduleByDate/'+$orgID+'/'+$date)
    .pipe(catchError(this.errorService.serverError), tap(((response: {success: number, data: any[]}) => {
      this.feesReceivedList=response.data;
      this.feesReceivedSubject.next([...this.feesReceivedList]);
    })));
  }
  fetchAllEmployeeServiceScheduleByDateTime($orgID:any,$date:any,$time:any){
    return this.http.get<any>(this.commonService.getAPI() + '/getEmployeeServiceScheduleByDateTime/'+$orgID+'/'+$date +'/'+$time)
    .pipe(catchError(this.errorService.serverError), tap(((response: {success: number, data: any[]}) => {
      this.feesReceivedList=response.data;
      this.feesReceivedSubject.next([...this.feesReceivedList]);
    })));
