...
@Component({
  selector: 'app-student-online-class',
  templateUrl: './student-online-class.component.html',
  styleUrls: ['./student-online-class.component.scss']
})
export class StudentOnlineClassComponent implements OnInit {

  tempNewsObj:object={};
  tempChargeObj:object={};
  tempReceicedObj:object={};
  studentOnlineClassArray:any[]=[];
  ...
  getStudentToCourseRegistrationListLedgerId($ledgerID:any){
    this.reportService.fetchStudentToCourseRegistrationReportLedgerId($ledgerID).subscribe(response => {
      ...
      this.getStudentOnlineClassList();
      
    })
  }
  getStudentOnlineClassList(){
    this.reportService.fetchStudentOnlineClassList(this.tempNewsObj).subscribe(response => {
      this.studentOnlineClassArray=response.data;
      console.log("studentOnlineClassArray:",this.studentOnlineClassArray);
    })
  }
